...
int main (int argc, char *argv[])
{
	...
	if (argc-1 < 5)
	{
		...
		printf("terminalPointFile = caminho para o .dat contendo os pontos terminais da rede de Purkinje.\n");
		printf("Try for example: ./purkinjeMiocardium 500 2.0 0.05 \
		Miocardium/Malha_Reduzida_Jesuliana/vent_reduzida_r4.vtk \
		Miocardium/Malha_Reduzida_Jesuliana/terminaisBenja_reduzido.dat \n");
	}
	else
	{
