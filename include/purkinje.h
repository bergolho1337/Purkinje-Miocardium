...
const double l_bra = 5.0 / scale_factor;				// Tamanho do ramo (mm) (default = 5mm)
...
const double Toler_tree = 4.0e-00 / scale_factor;		// Tolerancia para colisao na arvore (default = 4)
const double Toler_miocardium = 7.0e-00 / scale_factor;	// Tolerancia para colisao no miocardio (default = 7)
const double Toler_terminal = 5.0e-00 / scale_factor;	// Tolerancia para colisao com um terminal (default = 3)
// =============================================================================================================
